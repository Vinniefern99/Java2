...
public class SevenSegmentImage implements Cloneable 
{
    ...
    public static final int MAX_HEIGHT = 39;
    ...
    public boolean setSize(int width, int height) 
    {
        ...
        //topRow and leftCol wil always be zero
        //the above code in this method will test out bad values for 
        //width and height, so it's safe to do this here.
        topRow = 0;
        leftCol = 0;
        bottomRow = height - 1;
        rightCol = width - 1;
